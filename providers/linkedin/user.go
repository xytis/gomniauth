...
const (
	linkedinKeyID         string = "id"
	linkedinKeyName       string = "formattedName"
	linkedinKeyEmail      string = "emailAddress"
	linkedinKeyPictureUrl string = "pictureUrl"
)
...
// NewUser builds a new User object for Linkedin
func NewUser(data objx.Map, creds *common.Credentials, provider common.Provider) *User {
	user := &User{data}

	creds.Set(common.CredentialsKeyID, data[linkedinKeyID])
...
func (u *User) Email() string {
	return u.Data().Get(linkedinKeyEmail).Str()
}

// Name gets the users full name.
func (u *User) Name() string {
	return u.Data().Get(linkedinKeyName).Str()
...
func (u *User) AvatarURL() string {
	return u.Data().Get(linkedinKeyPictureUrl).Str()
}
